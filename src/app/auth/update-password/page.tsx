...
export default function UpdatePassword() {
  ...
  // Verify we have the token_hash and type params
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#FDF6EC]">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <Link
              href="/"
              className="inline-block px-4 py-2 bg-[#8B4513] text-white rounded-lg hover:bg-[#A0522D] transition-colors"
            >
              Return Home
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="w-full px-4 py-2 border border-[#8B4513] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B4513]/50 pr-10"
              />
              <button
                type="button"
